...
export default function CheckoutPage() {
  ...
  if (isSubmitted) {
    return (
      <main className="min-h-[80vh] flex items-center justify-center px-4 py-12">
        <div className="max-w-md w-full bg-white border border-zinc-200 rounded-3xl p-6 sm:p-8 text-center shadow-xl">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-emerald-100 text-emerald-600 mb-4">
            <CheckCircle2 className="h-10 w-10" />
          </div>
          <h1 className="text-2xl font-black text-zinc-90 uppercase tracking-tight">
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <h1 className="text-2xl sm:text-3xl font-black uppercase tracking-tight text-zinc-900 mb-6">
        Finalizar Compra
      </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 order-2 lg:order-1">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white border-zinc-200 rounded-2xl p-5 sm:p-6 shadow-sm">
              <div className="flex items-center gap-2 font-bold text-base text-zinc-900 mb-4 pb-3 border-b border-zinc-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2">
                  <label className="block text-xs font-semibold text-zinc-600 mb-1">Nombre Completo</label>
                  <input
                    type="text"
                    name="name"
                    required
                    ...
                    className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 transition"
                  />
                </div>

                <div className="sm:col-span-2">
                  <label className="block text-xs font-semibold text-zinc-600 mb-1">Correo Electrónico</label>
                  <input
                    type="email"
                    name="email"
                    required
                ...
                <div className="sm:col-span-2">
                  <label className="block text-xs font-semibold text-zinc-600 mb-1">Dirección de Entrega</label>
                  <input
                    type="text"
                    name="address"
                    required
                ...
                <div>
                  <label className="block text-xs font-semibold text-zinc-600 mb-1">Ciudad</label>
                  <input
                    type="text"
                    name="city"
                    required
                ...
                <div>
                  <label className="block text-xs font-semibold text-zinc-600 mb-1">Código Postal</label>
                  <input
                    type="text"
                    name="postalCode"
                    required
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-5 sm:p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-semibold text-zinc-600 mb-1">Número de Tarjeta</label>
                  <input
                    type="text"
                    name="cardNumber"
                    required
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-zinc-600 mb-1">Expiración</label>
                    <input
                      type="text"
                      name="cardExp"
                      required
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-zinc-600 mb-1">CVC / CVV</label>
                    <input
                      type="text"
                      name="cardCvc"
                      required
        ...
        <div className="lg:col-span-5 order-1 lg:order-2">
          <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-5 sm:p-6 sticky top-24">
            <h2 className="font-bold text-base text-zinc-900 mb-4 pb-3 border-b border-zinc-200">
            ...
            <div className="divide-y divide-zinc-200 max-h-72 overflow-y-auto pr-1">
              {cart.map((item) => (
                <div key={item.id} className="py-3 flex items-center gap-3">
                  <div className="relative h-14 w-14 flex-shrink-0 rounded-lg overflow-hidden bg-white border border-zinc-200">
                    <Image src={item.image} alt={item.name} fill className="object-cover" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="text-xs font-bold text-zinc-900 truncate">{item.name}</h3>
            ...
            {/* Desglose de Precios */}
            <div className="mt-4 pt-4 border-t border-zinc-200 space-y-2 text-xs">
